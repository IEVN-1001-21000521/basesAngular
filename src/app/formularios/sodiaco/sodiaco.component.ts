...
@Component({
  selector: 'app-sodiaco',
  templateUrl: './sodiaco.component.html',
  styleUrls: ['./sodiaco.component.css']
})
export class SodiacoComponent implements OnInit {
  ...
  private signosZodiacales: { [key: string]: string } = {
  ...
  obtenerSignoZodiacal(anio: number): string {
    const signos: string[] = ['Rata', 'Buey', 'Tigre', 'Conejo', 'Dragón', 'Serpiente', 'Caballo', 'Cabra', 'Mono', 'Gallo', 'Perro', 'Cerdo'];
    const baseYear = 1924;
